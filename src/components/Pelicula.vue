    ...
    <div class="container">
       ...
       <div class="row">
           ...
           <div class="col-12 col-sm-6  col-md-8">
               <h6 v-html="pelicula.descripcion"></h6>
               <div class="p-3 mb-2 text-white" :style="`${precioEstilos}`">
                   Precio: {{pelicula.precio}} BOB
               </div>
               <h5>Color</h5>
               <div>
                   <div v-for="color of pelicula.colores" class="color-box clic" @click="colorChange(color)" :style="`background: ${color}`"></div>
               </div>
               <h5>Cantidad</h5>
               <div class="quantity">
               ...
               <div class="buy-box">
                   <button type="button" class="btn btn-primary" @click="comprar(pelicula.id)" :disabled=botonEstado>Comprar</button>
               </div>
